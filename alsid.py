...
async def _(event):
        ...
        for i in range(100):
            ...
            try:
                ...
                await Tepthon.send_message(event.chat_id, f"خطأ من المحتمل تم حظر الانضمام ")
                break
...
@Tepthon.on(events.NewMessage(outgoing=True, pattern=r"\.تجميع الجوكر"))
async def _(event):
        await event.edit("حسنا, تأكد من انك مشترك ب قنوات الاشتراك الاجباري لتجنب الأخطأء")
...
@Tepthon.on(events.NewMessage(outgoing=True, pattern=".احسب (.*)"))
async def _(event):
    try:
...
@Tepthon.on(events.NewMessage(outgoing=True, pattern=".للكروبات(?: |$)(.*)"))
...
@Tepthon.on(events.NewMessage(outgoing=True, pattern=".للخاص(?: |$)(.*)"))
...
@Tepthon.on(events.NewMessage(outgoing=True, pattern=".تكرار (.*)"))
...
@Tepthon.on(events.NewMessage(outgoing=True, pattern=".مؤقت (.*)"))
async def spammer(event):
...
@Tepthon.on(events.NewMessage(outgoing=True, pattern=".قلوب"))
async def _(event):
...
@Tepthon.on(events.NewMessage(outgoing=True, pattern=".العد التنازلي"))
async def _(event):
    animation_interval = 0.3
    animation_ttl = range(54)
    event = await event.edit("🔟")
...
@Tepthon.on(events.NewMessage(outgoing=True, pattern=".قمر"))
async def _(event):
...
@Tepthon.on(events.NewMessage(outgoing=True, pattern=".قمور"))
async def _(event):
